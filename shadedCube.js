...
var ctm;
var ambientProduct, diffuseProduct, specularProduct; // cube 1
var ambientProduct2, diffuseProduct2, specularProduct2; // cube 2
...
window.onload = function init() {
	...
	//light for first cube
    ambientProduct = mult(lightAmbient, materialAmbient);
    diffuseProduct = mult(lightDiffuse, materialDiffuse);
    specularProduct = mult(lightSpecular, materialSpecular);

	//light for second cube
...
var render = function(){
	...
	modelView = mat4();
	modelView = mult(modelView, translate(-0.5, 0 , 0, 0));
